...
router.patch("/updateUsers/:id", (0, validateRequest_1.validateRequest)(user_validation_1.updateZodSchema), (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), user_controller_1.UserControllers.Updatuser);
